    ...
    <main className="flex flex-1 bg-zinc-50 px-5 py-6 font-sans text-zinc-950 dark:bg-black dark:text-zinc-50 sm:px-8 sm:py-8">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-12">
        <header className="flex items-center justify-between">
          <div>
            <p className="text-lg font-bold tracking-tight">OneTask DeFi</p>
        ...
        <section className="grid flex-1 items-center gap-12 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <h1 className="mt-5 max-w-xl text-4xl font-semibold leading-tight tracking-tight sm:text-5xl">
              Describe one outcome. Get one verifiable DeFi plan.
            </h1>

            <p className="mt-6 max-w-xl text-lg leading-8 text-zinc-600 dark:text-zinc-400">
              OneTask coordinates specialized agents, collects signed evidence,
              and lets the user approve a constrained execution plan.
            </p>
